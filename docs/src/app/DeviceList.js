...
const deviceList = [
  {
    ...
    img: 'assets/howtos/androidthings.png',
    link: '#/androidthings/intro',
    description: "Android Things lets you build professional, mass-market products on a trusted platform, without previous knowledge of embedded system design.",
  },
  {
    title: 'Raspberry Pi',
